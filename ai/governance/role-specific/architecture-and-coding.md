...
**Scope:** Applies to all agents responsible for architecture, design, or code generation. Required for Solution Architect, Backend Developer, Frontend Developer, and Database Developer agents.
