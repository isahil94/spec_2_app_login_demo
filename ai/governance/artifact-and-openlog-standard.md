...
This document defines the universal standards for artifact governance, handoff contracts, openlog management, and artifact ownership across all agents and workflows.
