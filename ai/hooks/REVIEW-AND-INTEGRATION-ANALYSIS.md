...
- All referenced MCP servers are configured (.vscode/mcp.json) ✓
...
| Config | `.vscode/mcp.json` | JSON | MCP server configuration |
...
| .vscode/mcp.json | ✓ Unchanged | Used by hooks for file access |
