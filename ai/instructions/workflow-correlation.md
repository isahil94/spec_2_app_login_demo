...
Approval Gate
  ...
  ├─ CORR-F2M4X1: Workflow runtime evaluates the approval request
  ├─ CORR-F2M4X1: Approval decision is recorded
  └─ CORR-F2M4X1: Backend Developer notified of the decision
